...
--
-- Class Counter as table counter
--
...
--
-- Class Merchant as table merchant
--
...
-- Indexes
CREATE UNIQUE INDEX "merchant_auth_user_idx" ON "merchant" USING btree ("authUserId");
...
--
-- Class StockLog as table stock_log
--
...
--
-- Class Terminal as table terminal
--
...
--
-- Foreign relations for "counter" table
--
...
--
-- Foreign relations for "stock_log" table
--
...
--
-- Foreign relations for "terminal" table
--
